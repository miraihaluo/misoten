...
//	private bool enableAttack_f = true;
	...
	/// 子供獲得時のパーティクルオブジェ
	/// </summary>
	private ParticleSystem getChildObj;
...
//	[SerializeField]
	...
	/// rootの参照
	/// </summary>
	[SerializeField, Header("ボーンのルート")]
	private Transform rootObj;

	/// <summary>
	/// プロペラオブジェ
	/// </summary>
	[SerializeField, Header("プロペラの参照")]
	private Transform[] propellerObj;
...
//		prefabAttackObj = (GameObject)Resources.Load("Prefabs/GameMain/AttackObj");
		...
		foreach (Transform child in transform)
		{
			...
			if (child.name == "GetChild")
				getChildObj = child.GetComponent<ParticleSystem>();
		}
...
//		if (score - decScore < 0) return 0;
	...
	{
		foreach (Transform obj in propellerObj)
		{
			obj.Rotate(0.0f, 500 * Time.deltaTime, 0.0f);
		
		}

	}

	public void ChangePlayerStatus(E_STATUS changeStatus)
	{
		// 終了処理
		switch (eStatus)
		{
